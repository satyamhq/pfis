...
export const GovernmentLayout: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50/70">
      ...
      <div className="bg-emerald-950 text-emerald-100 px-4 py-2 text-xs flex items-center justify-between shadow-xs border-b border-emerald-800/40">
        <div className="flex items-center gap-2 max-w-7xl 2xl:max-w-[1440px] mx-auto w-full">
          ...
          <div className="ml-auto flex items-center gap-1 text-emerald-300 bg-emerald-900 px-2 py-0.5 rounded-full text-[11px] font-medium border border-emerald-700">
