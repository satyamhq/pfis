  ...
  const roleOptions: RoleOption[] = [
    {
      ...
      description: 'Calculate your personal healthcare accessibility score, explore accredited facilities, and schedule windowed OPD intake tokens.',
      highlights: [
        '8-Dimension Friction Fingerprint™',
        'Windowed OPD Consultation Booking',
        'Doorstep Transit & Escort Logistics',
      ],
    },
    {
      id: 'doctor',
      ...
      description: 'Review patient socio-geographic friction indices, transit barriers, and follow-up attrition hazard without compromising clinical autonomy.',
      highlights: [
        'Pre-Consultation Friction Intelligence',
        'Care Adherence & Dropout Predictor',
        'Direct ASHA Cadre Coordination',
      ],
    },
    {
      id: 'asha',
      ...
      description: 'Monitor village households, log grassroots healthcare access barriers, and initiate assisted transit and escort requests.',
      highlights: [
        'Household Health Cohort Registry',
        'Rapid Non-Clinical Barrier Telemetry',
        'Doorstep Transit & Sahayak Dispatch',
      ],
    },
    {
      id: 'hospital',
      ...
      description: 'Triage incoming patient intake requests, optimize departmental OPD token capacity, and coordinate facility-level barrier mitigation.',
      highlights: [
        'Real-Time Intake Triage Queue',
        'Specialist Roster & Token Balancing',
        '24/7 Emergency & Bed Telemetry',
      ],
    },
    {
      id: 'government',
      ...
      description: 'Analyze aggregated district friction heatmaps, track 5-stage care continuum drop-off, and simulate targeted health interventions.',
      highlights: [
        'Macro Friction & Density Heatmaps',
        '5-Stage Care Continuum Leakage Funnel',
        'Intervention Budget & Impact Simulator',
      ],
    },
  ];
