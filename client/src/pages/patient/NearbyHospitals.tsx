                      ...
                      <div className="space-y-0.5">
                        <div className="flex items-center gap-1.5 flex-wrap">
                          ...
                          {hosp.emergencyAvailable && (
                            <span className="text-[10px] font-bold px-2 py-0.5 rounded-full bg-red-100 text-red-700 dark:bg-red-950/60 dark:text-red-300 border border-red-200 dark:border-red-900 flex items-center gap-1">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs">
                      <div className="p-2.5 rounded-xl bg-rose-50/90 dark:bg-rose-950/30 border border-rose-200/80 dark:border-rose-900/60 flex items-center justify-between">
                        <div className="flex items-center gap-2.5">
                          <div className="w-8 h-8 rounded-lg bg-rose-100 dark:bg-rose-900/50 flex items-center justify-center text-rose-600 dark:text-rose-400 shrink-0">
                      ...
                      <div className="space-y-1.5 bg-emerald-50/70 dark:bg-emerald-950/30 p-2.5 rounded-xl border border-emerald-200/80 dark:border-emerald-900/60">
                        ...
                        <div className="flex flex-wrap gap-1 pt-0.5">
                          {hosp.allTreatedConditions.slice(0, 8).map((cond: string, idx: number) => (
                            <span
                              key={idx}
                              className="text-[10px] bg-white dark:bg-slate-900 text-emerald-900 dark:text-emerald-200 px-2 py-0.5 rounded-md font-medium border border-emerald-200/80 dark:border-emerald-800 shadow-2xs flex items-center gap-1"
                            >
